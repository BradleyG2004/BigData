...
def write_to_postgresql(df):
    ...
    def write_batch_to_postgres(batch_df, batch_id):
        ...
        try:
            ...
            # Déduplication au niveau du batch (garder la dernière valeur par mongo_id)
            deduplicated_df = batch_df.dropDuplicates(["mongo_id"])
